...
# =============================================================================
    ...
    if(angle == 0):
        ...
        if(0< grid_search.north and rotation_direction.check == 0):
        ...
        elif(grid_search.north <0 and rotation_direction.check == 0):
            grid_search.right_speed = -grid_search.max_speed/5
            grid_search.left_speed = grid_search.max_speed/5
            rotation_direction.counter = grid_search.const_counter
            rotation_direction.counter_start = rotation_direction.counter
    ...
    if(angle == 1):
        ...
        if(-1.5708< grid_search.north <1.5708 and rotation_direction.check == 0):
            grid_search.right_speed = -grid_search.max_speed/5
            grid_search.left_speed = grid_search.max_speed/5
            rotation_direction.counter = grid_search.const_counter
            rotation_direction.counter_start = rotation_direction.counter
        ...
        elif((grid_search.north <-1.5708 or 1.5708< grid_search.north) and rotation_direction.check == 0):
            grid_search.right_speed = grid_search.max_speed/5
            grid_search.left_speed = -grid_search.max_speed/5
            rotation_direction.counter = grid_search.const_counter
            rotation_direction.counter_start = rotation_direction.counter
    ...
    if(angle == 2):
        ...
        if(0< grid_search.north <3.1416 and rotation_direction.check == 0):
            grid_search.right_speed = -grid_search.max_speed/5
            grid_search.left_speed = grid_search.max_speed/5
            rotation_direction.counter = grid_search.const_counter
            rotation_direction.slow = 45
        ...
        elif(-3.1416< grid_search.north <0 and rotation_direction.check == 0):
            grid_search.right_speed = grid_search.max_speed/5
            grid_search.left_speed = -grid_search.max_speed/5
            rotation_direction.counter = grid_search.const_counter
            rotation_direction.slow = 45
    ...
    if(rotation_direction.counter < rotation_direction.counter_start - rotation_direction.slow):
        grid_search.left_speed /= 3.024577
        grid_search.right_speed /= 3.024577
        # print("slowing")
...
# =============================================================================
    ...
    if(grid_search.rot_state == 1):
        ...
        rotation_direction(grid_search.rot_angle) 
