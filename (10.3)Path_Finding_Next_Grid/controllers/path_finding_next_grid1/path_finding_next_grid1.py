...
if __name__ == "__main__":
    ...
    rotation_direction.diveded_speed = 5
    rotation_direction.fix = 0
    rotation_direction.fix_state = 0
    
    
    rotation_direction.check = 0
    rotation_direction.diveded_speed_set = 0
    rotation_direction.counter = -1
