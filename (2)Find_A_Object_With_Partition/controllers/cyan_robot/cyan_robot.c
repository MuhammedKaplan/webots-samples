...
int main(int argc, char **argv)
{
  ...
  WbNodeRef cyan_robot_node = wb_supervisor_node_get_from_def("MY_ROBOT_CYAN");
  ...
  WbFieldRef robot_trans_field = wb_supervisor_node_get_field(cyan_robot_node, "translation");
  WbFieldRef robot_rot_field = wb_supervisor_node_get_field(cyan_robot_node, "rotation");
  ...
  // Check root nodes
  if (cyan_robot_node == NULL)
  {
    fprintf(stderr, "No DEF MY_ROBOT_CYAN node found in the current world file\n");
    exit(1);
  }
