...
int main(int argc, char **argv)
{
  ...
  WbNodeRef blue_robot_node = wb_supervisor_node_get_from_def("MY_ROBOT_BLUE");
  ...
  WbFieldRef robot_trans_field = wb_supervisor_node_get_field(blue_robot_node, "translation");
  WbFieldRef robot_rot_field = wb_supervisor_node_get_field(blue_robot_node, "rotation");
  ...
  // Check root nodes
  if (blue_robot_node == NULL)
  {
    fprintf(stderr, "No DEF MY_ROBOT_BLUE node found in the current world file\n");
    exit(1);
  }
