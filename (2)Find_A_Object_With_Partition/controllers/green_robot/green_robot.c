...
int main(int argc, char **argv)
{
  ...
  WbNodeRef green_robot_node = wb_supervisor_node_get_from_def("MY_ROBOT_GREEN");
  ...
  WbFieldRef robot_trans_field = wb_supervisor_node_get_field(green_robot_node, "translation");
  WbFieldRef robot_rot_field = wb_supervisor_node_get_field(green_robot_node, "rotation");
  ...
  // Check root nodes
  if (green_robot_node == NULL)
  {
    fprintf(stderr, "No DEF MY_ROBOT_GREEN node found in the current world file\n");
    exit(1);
  }
