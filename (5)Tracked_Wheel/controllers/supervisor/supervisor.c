...
int main() {
  WbDeviceTag leftF_motor, leftR_motor, rightF_motor, rightR_motor, ds, compass, iu, accelerometer;
  ...
  while (wb_robot_step(time_step) != -1) {
    ...
    const double *accVal = wb_accelerometer_get_values(accelerometer);
