...
def grid_search(robot):
    ...
    while robot.step(grid_search.time_step) != -1:
        ...
        grid_search.receiver.setChannel(grid_search.robot, 1)
...
# =============================================================================
    ...
    if(target_pos_search.message_send == 1):
        grid_search.emitter.setChannel(grid_search.robot, 1)
        message = struct.pack("hhh",1,target_pos_search.x,target_pos_search.y)
        byte = 3
        for j in range(grid_search.cols):
            for i in range(grid_search.rows):
                if(grid_search.grid_map[i][j] != 0):
...
# =============================================================================
    ...
    if(grid_search.ps_left_value > cal_next_step_range.rangeLeft-0.002 and grid_search.movement_check == 1):
        ...
        grid_search.emitter.setChannel(grid_search.robot, 2)
        message = struct.pack("hh",grid_search.cur_pos_x,grid_search.cur_pos_y)
        grid_search.emitter.send(message)
...
def block_check():
    ...
    grid_search.receiver.setChannel(grid_search.robot, 2)
    ...
    if(grid_search.ds_front_value < 1535):
        ...
        if(-0.01<grid_search.north<0.01 and dataList[0] != grid_search.cur_pos_x + 1 and dataList[1] != grid_search.cur_pos_y ):
            grid_search.grid_map[grid_search.cur_pos_x + 1][grid_search.cur_pos_y] = 3
        # If direction of robot is east
        if(1.56<grid_search.north<1.58 and dataList[0] != grid_search.cur_pos_x and dataList[1] != grid_search.cur_pos_y + 1):
            grid_search.grid_map[grid_search.cur_pos_x][grid_search.cur_pos_y + 1] = 3
        
        # If direction of robot is south
        if(-3.15<grid_search.north<-3.13 or 3.13<grid_search.north<3.15 and dataList[0] != grid_search.cur_pos_x - 1 and dataList[1] != grid_search.cur_pos_y ):
            grid_search.grid_map[grid_search.cur_pos_x - 1][grid_search.cur_pos_y] = 3
        
        # If direction of robot is west
        if(-1.58<grid_search.north<-1.56 and dataList[0] != grid_search.cur_pos_x and dataList[1] != grid_search.cur_pos_y - 1):
            grid_search.grid_map[grid_search.cur_pos_x][grid_search.cur_pos_y - 1] = 3
    ...
    if(grid_search.ds_right_value < 1535):
        ...
        # If direction of robot is north
        if(-0.01<grid_search.north<0.01 and dataList[0] != grid_search.cur_pos_x and dataList[1] != grid_search.cur_pos_y + 1):
            grid_search.grid_map[grid_search.cur_pos_x][grid_search.cur_pos_y + 1] = 3
        # If direction of robot is east
        if(1.56<grid_search.north<1.58 and dataList[0] != grid_search.cur_pos_x - 1 and dataList[1] != grid_search.cur_pos_y ):
            grid_search.grid_map[grid_search.cur_pos_x - 1][grid_search.cur_pos_y] = 3
        # If direction of robot is south
        if(-3.15<grid_search.north<-3.13 or 3.13<grid_search.north<3.15 and dataList[0] != grid_search.cur_pos_x and dataList[1] != grid_search.cur_pos_y - 1):
            grid_search.grid_map[grid_search.cur_pos_x][grid_search.cur_pos_y - 1] = 3    
        # If direction of robot is west
        if(-1.58<grid_search.north<-1.56 and dataList[0] != grid_search.cur_pos_x + 1 and dataList[1] != grid_search.cur_pos_y ):
            grid_search.grid_map[grid_search.cur_pos_x + 1][grid_search.cur_pos_y] = 3
