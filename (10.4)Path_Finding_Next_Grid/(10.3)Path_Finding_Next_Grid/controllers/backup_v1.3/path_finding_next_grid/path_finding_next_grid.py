...
# =============================================================================
    ...
    if(angle == 0):
        if((-3.15<grid_search.north<-3.13 or 3.13<grid_search.north<3.15) and rotation_direction.check == 0):
            ...
            rotation_direction.counter = int(2 * grid_search.const_counter - 1)
            ...
            grid_search.right_speed = grid_search.max_speed/5
            grid_search.left_speed = -grid_search.max_speed/5
            rotation_direction.counter = int(grid_search.const_counter)
            rotation_direction.counter_start = rotation_direction.counter
...
# =============================================================================
    ...
    if(grid_search.rot_state == 1):
        ...
        if(rotation_direction.counter == 0):
            ...
            if grid_search.rot_angle == 0:
                if grid_search.north < 0 or 0 < grid_search.north:
                    a = abs(grid_search.north)
                    grid_search.const_counter += a / 0.0008
            
            #east
            if grid_search.rot_angle == 1:
                if grid_search.north < 1.5708 or 1.5708 < grid_search.north:
                    a = abs(grid_search.north - 1.5708)
                    grid_search.const_counter += a / 0.0008
                    
            if grid_search.rot_angle == 2:
                if grid_search.north < 3.1416 or -3.1416 < grid_search.north:
                    a = abs(abs(grid_search.north) - 3.1416)
                    grid_search.const_counter += a / 0.0008
                    
            if grid_search.rot_angle == 3:
                if grid_search.north < -1.5708 or -1.5708 < grid_search.north:
                    a = abs(abs(grid_search.north) - 1.5708)
                    grid_search.const_counter += a / 0.0008
        ...
        #         rotation_direction.counter = -1
        #         rotation_direction.slow_check = 0
        #         grid_search.const_counter += 0.005
        #         # print("turn end")
