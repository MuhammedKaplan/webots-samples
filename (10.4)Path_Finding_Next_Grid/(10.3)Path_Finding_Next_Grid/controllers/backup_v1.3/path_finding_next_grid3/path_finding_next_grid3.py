...
# =============================================================================
    ...
    if((target_pos_search.found == 1 or target_pos_search.sng_state == 1) and cal_next_step_range.state == 0):
        ...
        if((target_pos_search.direction == "north" and -0.02<grid_search.north<0.02)
            or (target_pos_search.direction == "east" and 1.55<grid_search.north<1.58)
            or (target_pos_search.direction == "south" and (-3.15<grid_search.north<-3.12 or 3.12<grid_search.north<3.15))
            or (target_pos_search.direction == "west" and -1.59<grid_search.north<-1.55)):
...
# =============================================================================
    ...
    # Else go forward
        ...
        if(grid_search.grid_map[target_pos_search.x][target_pos_search.y] == 4
           ...
           or grid_search.ds_front_value < 240 or grid_search.ds_front_l < 250
           or grid_search.ds_front_r < 250):
