...
# =============================================================================
    ...
    # if (target_pos_search.target_found == 0):
    #     grid_search.final_state = 1
    #     print("final state 1")
    ...
    if (grid_search.final_state == 1 and target_pos_search.sng_state == 0):
        if(search_area.found == 0 and search_area.r5_final == 1
           and search_area.r4_final == 1 and search_area.r7_final == 1):            
            ...
            # for j in range(len(grid_search.grid_map[0])-1):
            #     for i in range(len(grid_search.grid_map)-1):
            #         if(grid_search.grid_map[i][j] == 1):
            #             grid_search.grid_map[i][j] = 0
